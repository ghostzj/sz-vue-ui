    ...
    <span
      ...
      <i
        ...
        <i
          ...
          :style="decimalStyle"
          class="sz-rate__decimal">
        </i>
      </i>
    </span>
    <span v-if="showText || showScore" class="sz-rate__text" :style="{ color: textColor }">{{ text }}</span>
  </div>
</template>
...
export default {
  ...
  props: {
    ...
    iconClasses: {
      type: [Array, Object],
      default() {
        return ['sz-icon-star-on', 'sz-icon-star-on', 'sz-icon-star-on'];
      }
    },
    voidIconClass: {
      type: String,
      default: 'sz-icon-star-off'
    },
    disabledVoidIconClass: {
      type: String,
      default: 'sz-icon-star-on'
    },
    disabled: {
      type: Boolean,
      default: false
  ...
  methods: {
    ...
    setCurrentValue(value, event) {
      ...
      if (this.allowHalf) {
        ...
        if (hasClass(target, 'sz-rate__item')) {
          target = target.querySelector('.sz-rate__icon');
        }
        if (hasClass(target, 'sz-rate__decimal')) {
