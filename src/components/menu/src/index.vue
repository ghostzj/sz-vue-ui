...
export default {
  ...
  render(h) {
    const component = (
      <ul
        ...
        class={{
          'sz-menu--horizontal': this.mode === 'horizontal',
          'sz-menu--collapse': this.collapse,
          'sz-menu': true
        }}
      >
        { this.$slots.default }
      ...
      render(createElement, context) {
        const data = {
          ...
          on: {
            ...
            enter(el) {
              addClass(el, 'sz-opacity-transition');
              el.style.opacity = 1;
            },

            afterEnter(el) {
              removeClass(el, 'sz-opacity-transition');
              el.style.opacity = '';
            },
            ...
            beforeLeave(el) {
              ...
              if (hasClass(el, 'sz-menu--collapse')) {
                removeClass(el, 'sz-menu--collapse');
                el.dataset.oldOverflow = el.style.overflow;
                el.dataset.scrollWidth = el.clientWidth;
                addClass(el, 'sz-menu--collapse');
              } else {
                addClass(el, 'sz-menu--collapse');
                el.dataset.oldOverflow = el.style.overflow;
                el.dataset.scrollWidth = el.clientWidth;
  ...
  watch: {
    ...
    collapse(value) {
      ...
      this.broadcast('SzSubmenu', 'toggle-collapse', value);
    }
  },
  methods: {
