...
export default {
  ...
  methods: {
    ...
    renderCheckIcon(h) {
      return (
        <i class="sz-icon-check sz-cascader-node__prefix"></i>
      );
    },

    renderLoadingIcon(h) {
      return (
        <i class="sz-icon-loading sz-cascader-node__postfix"></i>
      );
    },

    renderExpandIcon(h) {
      return (
        <i class="sz-icon-arrow-right sz-cascader-node__postfix"></i>
      );
    },
    ...
    renderContent(h) {
      ...
      return (
        <span class="sz-cascader-node__label">{ vnode || node.label }</span>
      );
    }
  },
