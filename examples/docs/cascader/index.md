...
<div class="block">
  ...
  <sz-cascader
    v-model="value"
    :options="options"
    @change="handleChange"></sz-cascader>
</div>
<div class="block">
...
```html
<sz-cascader :options="options"></sz-cascader>
...
:::demo
```html
<sz-cascader :options="options" clearable></sz-cascader>
...
```html
<sz-cascader :options="options" :show-all-levels="false"></sz-cascader>
...
```html
<sz-cascader :props="props"></sz-cascader>
...
```html
<sz-cascader-panel :options="options"></sz-cascader-panel>
