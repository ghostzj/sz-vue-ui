...
:::demo
```html
<sz-tree :data="data" :props="defaultProps" @node-click="handleNodeClick"></sz-tree>
...
<div class="buttons">
  <sz-button @click="getCheckedNodes">通过 node 获取</sz-button>
  <sz-button @click="getCheckedKeys">通过 key 获取</sz-button>
  <sz-button @click="setCheckedNodes">通过 node 设置</sz-button>
  <sz-button @click="setCheckedKeys">通过 key 设置</sz-button>
  <sz-button @click="resetChecked">清空</sz-button>
</div>
      ...
      renderContent(h, { node, data, store }) {
        return (
          <span class="custom-tree-node">
            <span>{node.label}</span>
            <span>
              <sz-button size="mini" type="text" on-click={ () => this.append(data) }>Append</sz-button>
              <sz-button size="mini" type="text" on-click={ () => this.remove(node, data) }>Delete</sz-button>
            </span>
          </span>);
      }
    }
